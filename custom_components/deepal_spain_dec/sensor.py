...
SENSOR_DESCRIPTIONS: tuple[
    ...
    DeepalSensorDescription(
        ...
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda data: data.outside_temperature_c,
    ),
    DeepalSensorDescription(
        key="cabin_humidity",
    ...
    DeepalSensorDescription(
        key="front_left_window_percent",
        translation_key="front_left_window_percent",
        name="Apertura ventana delantera izquierda",
        icon="mdi:car-door",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda data: data.front_left_window_percent,
    ),
    DeepalSensorDescription(
        key="front_right_window_percent",
        translation_key="front_right_window_percent",
        name="Apertura ventana delantera derecha",
        icon="mdi:car-door",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda data: data.front_right_window_percent,
    ),
    DeepalSensorDescription(
        key="rear_left_window_percent",
        translation_key="rear_left_window_percent",
        name="Apertura ventana trasera izquierda",
        icon="mdi:car-door",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda data: data.rear_left_window_percent,
    ),
    DeepalSensorDescription(
        key="rear_right_window_percent",
        translation_key="rear_right_window_percent",
        name="Apertura ventana trasera derecha",
        icon="mdi:car-door",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda data: data.rear_right_window_percent,
    ),
)
